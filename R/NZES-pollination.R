...
#' @param pollendemand Vector of pollen demand per month kg
...
#' @return Raster layer indicating the annual carrying capacity in colonies per pixel
#' @export
